...
from diffusers import SanaPipeline # run `pip install git+https://github.com/huggingface/diffusers` before use Sana in diffusers
...
def main():
    ...
    for tag, prompts in prompts_by_tag.items():
        ...
        for prompt_data in prompts:
            ...
            image = pipe(prompt, height=512, width=512, guidance_scale=4.5, num_inference_steps=100)[0] 
            ...
            for step in range(1, 4):
                ...
                image = pipe(refined_prompt, height=512, width=512, guidance_scale=4.5, num_inference_steps=100)[0] 
