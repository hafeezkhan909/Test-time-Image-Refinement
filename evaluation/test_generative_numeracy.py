...
base_image_path = "data/generative_numeracy/method_t-25/"
...
for query_id, query_data in test_queries.items():
    ...
    # Save visualization
    save_path = f"data/generative_numeracy/method_t-25/detection_visualization/img_{query_id}_numeracy.png"
...
with open("data/generative_numeracy/method_t-25/method_t-25_numeracy_results.json", "w") as json_file:
