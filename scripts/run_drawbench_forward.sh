...
RESTART_STEPS=(5 15 25)  # Modify this array as needed
REFINEMENT_STEP=99
OUTPUT_DIR="drawbench/drawbench_raw_images"
DRAWBENCH_OUTPUT_DIR="drawbench/drawbench_gen_images"

python src/forward_injection/main.py --model_version 2.1 --prompts_file drawbench_prompts.json --output_dir "$OUTPUT_DIR" --restart_steps "${RESTART_STEPS[@]}" --refinement_step $REFINEMENT_STEP
